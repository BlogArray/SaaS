...
public class UrlExtensionsTests
{
    ...
    {
        string result = "https://id.blogarray.dev/".BuildUrl("resetpassword");

        Assert.Equal("https://id.blogarray.dev/resetpassword", result);
    }
    ...
    {
        string result = "https://id.blogarray.dev".BuildUrl("resetpassword", new { code = "abc123", tenant = "acme" });

        Assert.Equal("https://id.blogarray.dev/resetpassword?code=abc123&tenant=acme", result);
    }

    [Fact]
    public void BuildUrl_WithoutQueryParameters_HasNoQuery()
    {
        string result = "https://id.blogarray.dev".BuildUrl("forgotpassword");
